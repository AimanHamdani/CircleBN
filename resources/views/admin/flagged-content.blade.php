<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Flagged Content</h2>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 space-y-3 text-sm text-gray-800 dark:text-gray-100">
                ...
                @empty
                    <p class="text-gray-500 dark:text-gray-300">No flagged content in open state.</p>
                @endforelse
